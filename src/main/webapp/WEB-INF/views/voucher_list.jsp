                    ...
                    <tbody>
                        <c:forEach var="voucher" items="${vouchers}">
                            <tr>
                                ...
                                <td>
                                    <div class="product-name">${voucher.name}</div>
                                </td>
                                <td>
                                    <div class="product-name">${voucher.dateStart}</div>
                                </td>
                                <td>
                                    <div class="product-name">${voucher.dateEnd}</div>
                                </td>
                                <c:if test="${voucher.percentDiscount != null}">
                                	<td>
                                    	<div class="product-name">${voucher.percentDiscount}%</div>
                                	</td>
                                </c:if>
                                <c:if test="${voucher.valueDiscount != null}">
                                	<td>
                                    	<div class="product-name">${voucher.valueDiscount}</div>
                                	</td>
                                </c:if>
                                <td>
                                    <a href="${pageContext.request.contextPath}/voucher/edit/${voucher.code}" 
                                       class="btn-action btn-edit">
                                        <i class="fas fa-edit me-1"></i>Sửa
                                    </a>
                                    <a href="${pageContext.request.contextPath}/voucher/delete/${voucher.code}" 
