  ...
  <jsp:include page="/WEB-INF/views/common/header.jsp" />
    <div class="container">
      <div class="form-container">
        <h2 class="text-center text-primary mb-4">Thêm voucher mới</h2>
        ...
        <form:form
          method="post"
          action="${pageContext.request.contextPath}/voucher/add"
        ...
        >
          ...
          <div class="mb-3">
            ...
            <select class="form-control" id="type">
            	<option value="value">Giảm theo giá</option>
            	<option value="percent">Giảm theo phần trăm</option>
            </select>
          </div>
          
          <div class="mb-3" id="percent">
            <label for="percentDiscount" class="form-label">Giảm giá:</label>
            <form:input
          ...
          <div class="mb-3" id="value">
            <label for="valueDiscount" class="form-label">Giảm giá:</label>
            <form:input
              path="valueDiscount"
              class="form-control"
              type="number"
    ...
    <script>
      ...
      if(type.value == 'value'){
      	...
      	document.getElementById('value').setAttribute('required', 'required');
