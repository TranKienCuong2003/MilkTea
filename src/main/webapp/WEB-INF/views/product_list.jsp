                    ...
                    <tbody>
                        <c:forEach var="product" items="${products}">
                            <tr>
                                ...
                                <td>
                                    <div class="product-category">${product.tenDM}</div>
                                </td>
                                <td>
                                ...
                                <td>
                                    <div class="product-quantity">
                                        <fmt:formatNumber value="${product.soLuong}" type="number"/>
                                    </div>
                                </td>
                                <td>
                                    <span class="status-badge ${product.soLuong > 0 ? 'status-active' : 'status-inactive'}">
