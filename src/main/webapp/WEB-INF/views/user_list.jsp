...
<head>
    <meta charset="UTF-8">
    <title>Quản lý nhân viên - Milk Tea Shop</title>
    ...
    <div class="main-content">
        <div class="container">
            ...
            <div class="search-bar d-flex justify-content-between align-items-center">
                ...
                <a href="${pageContext.request.contextPath}/user/add" class="btn-add">
                    ...
                    <tbody>
                        <c:forEach var="user" items="${users}">
                            <tr>
                                ...
                                <td>
                                    <div class="product-name">${user.soDienThoai}</div>
                                </td>
                                <td>
                                    <div class="product-name">${user.tenDangNhap}</div>
                                </td>
                                <td>
                                    <div class="product-name">${user.matKhau}</div>
                                </td>
                                <td>
                                    <a href="${pageContext.request.contextPath}/user/edit/${user.maNd}" 
                                       class="btn-action btn-edit">
                                        <i class="fas fa-edit me-1"></i>Sửa
                                    </a>
                                    <a href="${pageContext.request.contextPath}/user/delete/${user.maNd}" 
