...
<head>
    <meta charset="UTF-8">
    <title>Quản lý kho - Milk Tea Shop</title>
...
<body>
    ...
    <div class="main-content">
        <div class="container">
            <h1 class="page-title">
                <i class="fas fa-list"></i> Danh sách kho
            </h1>
                ...
                <table class="table">
                    ...
                    <tbody>
                        <c:forEach var="warehouse" items="${warehouses}">
                            <tr>
                                <td>
                                    <div class="product-name">${warehouse.name}</div>
                                </td>
                                <td>
                                    <div class="product-name">${warehouse.address}</div>
                                </td>
                                <td>
                                    <div class="product-name"><fmt:formatDate value="${warehouse.importDate}" pattern="dd/MM/yyyy"/></div>
                                </td>
                                <td>
                                    <div class="product-name"><fmt:formatDate value="${warehouse.expiryDate}" pattern="dd/MM/yyyy"/></div>
                                </td>
                                <td>
                                    <div class="product-name">${warehouse.supplierName}</div>
                                </td>
                                <td>
                                    <a href="${pageContext.request.contextPath}/warehouse/edit/${warehouse.code}" 
                                       class="btn-action btn-edit">
                                        <i class="fas fa-edit me-1"></i>Sửa
                                    </a>
                                    <a href="${pageContext.request.contextPath}/warehouse/delete/${warehouse.code}" 
