    ...
    <div class="main-content">
        <div class="container">
            ...
            <div class="product-table">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="product-price">
                                        <fmt:formatNumber value="${orderDetail.donGia}" type="currency" currencySymbol="đ"/>
                                    </div>
                                </td>
                                <td>
                                ...
                                <td>
                                    <div class="product-price">
                                        <fmt:formatNumber value="${orderDetail.thanhTien}" type="currency" currencySymbol="đ"/>
                                    </div>
                                </td>
                            </tr>
                        </c:forEach>
                ...
                <div class="p-4">
    <c:if test="${not empty valueVoucher}">
        <div class="d-flex justify-content-end mb-2 text-success">
            <strong class="me-3">Giảm giá:</strong>
            <span>-<fmt:formatNumber value="${valueVoucher}" type="currency" currencySymbol="₫" /></span>
        </div>
    </c:if>
    <c:if test="${not empty percentVoucher}">
        <div class="d-flex justify-content-end mb-2 text-success">
            <strong class="me-3">Giảm giá:</strong>
            <span>-<fmt:formatNumber value="${percentVoucher}" type="number" maxFractionDigits="0"/>%</span>
        </div>
    </c:if>
