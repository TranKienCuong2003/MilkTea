  ...
  <body>
    ...
    <div class="container">
      <div class="form-container">
        ...
        <form:form
          method="post"
          action="${pageContext.request.contextPath}/voucher/edit/${voucher.code}"
        ...
        >
          ...
          <div class="mb-3">
            <label for="percentDiscount" class="form-label"
          ...
          <div class="mb-3">
            <label for="valueDiscount" class="form-label"
              >Giảm giá cố định (VNĐ) (nếu có):</label
            >
            <form:input
              path="valueDiscount"
              class="form-control"
